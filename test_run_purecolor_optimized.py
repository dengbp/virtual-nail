...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="调用 nail_sdxl_inpaint_purecolor_optimized_v2 处理纯色美甲渲染（优化版本）")
    ...
    for i, img_path in enumerate(img_files, 1):
        ...
        try:
            ...
            result_path = process_one_optimized_v2(img_path, ref_path, mask_path)
            if result_path:
